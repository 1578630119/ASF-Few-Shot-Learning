...
#parser.add_argument("-i", "--input-image", type=str,default='orange.jpg', required=True, help="/Path/to/input/image/file/")
...
args.input_image=input('Input image filename:')
...
'''params=regressor.state_dict() #获得模型的原始状态以及参数。
