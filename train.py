...
from model import  Resnet50FPN,Count_attention,weights_normal_init,weights_xavier_init
...
parser.add_argument("-dp", "--data_path", type=str, default='../LearningToCountEverything-master/data/',
                    help="Path to the FSC1  47 dataset")
...
im_dir = data_path + 'dataset/images_384_VarV2'
gt_dir = data_path + 'dataset/gt_density_map_adaptive_384_VarV2'
...
regressor = Count_attention(6, pool='mean')
...
for epoch in range(0,args.epochs):
    ...
    stats_file = join(args.output_dir, "stats_all1+2" +  ".txt")
    ...
    if best_mae >= val_mae:
        best_mae = val_mae
        best_rmse = val_rmse
        model_name = args.output_dir + '/' + "ASFNet.pth"
