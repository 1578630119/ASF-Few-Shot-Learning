...
import copy
from model import Resnet50FPN,Count_attention
...
parser.add_argument("-dp", "--data_path", type=str, default='data/', help="Path to the FSC147 datssaset")
...
parser.add_argument("-m",  "--model_path", type=str, default="logsSave/ASFNet_Save.pth", help="path to trained model")
